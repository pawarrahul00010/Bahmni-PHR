...
import org.openmrs.module.phr.web.contract.AppointmentServiceDefaultResponse;
...
public class PhrAppointmentMapperTest {
    ...
    public void setUp() throws Exception {
        ...
        service.setAppointmentServiceId(1);
        ...
        serviceType.setName("Online Appointment");
        serviceType.setUuid("serviceTypeUuid");
        serviceType.setAppointmentService(service);
        ...
        when(phrappointmentMapper.getServiceTypeByNameAndServiceId(service.getAppointmentServiceId())).thenReturn(serviceType);
    ...
    private AppointmentPayload createAppointmentPayload() throws ParseException {
        ...
        appointmentPayload.setMobileNumber("9999999999");
        ...
        String startDateTime = "2020-08-15T16:57:09.0Z";
        ...
        String endDateTime = "2020-08-15T17:12:09.0Z";
