...
@Component
public class OldAppointmentMapper {
    @Autowired
	...
	@Autowired
	PhrAppointmentServiceMapper appointmentServiceMapper;
	
    @Autowired
    AppointmentsService appointmentsService;
    
    private static final Logger logger = LoggerFactory.getLogger(OldAppointmentMapper.class);
    ...
    public Appointment getAppointmentFromPayload(AppointmentPayload appointmentPayload) {
        ...
        logger.warn(String.valueOf(appointmentService.getAppointmentServiceId())+"===>AppointmentService Id ");

		/*
		 * if(appointmentPayload.getServiceTypeUuid() != null) { appointmentServiceType
		 * = getServiceTypeByUuid(appointmentService.getServiceTypes(true),
		 * appointmentPayload.getServiceTypeUuid()); }
		 */
    ...
    AppointmentServiceType getServiceTypeByNameAndServiceId(int ServiceId){
    	...
    	AppointmentServiceType serviceType = appointmentServiceService.getAppointmentServiceTypeByName(ServiceId, "Online Appointment");
